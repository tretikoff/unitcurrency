...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mon May 28 13:37:19 2018
# Project:  utcoin-qt.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile utcoin-qt.pro
#############################################################################
...
DIST          = /usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/common/unix.conf \
		...
		/usr/local/Cellar/qt-webkit@2.3/2.3.4_1/etc/qt4/mkspecs/modules/qt_webkit.pri \
...
Makefile: utcoin-qt.pro  /usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Makefile utcoin-qt.pro
...
Decayscript-Qt.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,0.7,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,bitcoin.icns,g" -e "s,@EXECUTABLE@,Decayscript-Qt,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >Decayscript-Qt.app/Contents/Info.plist
...
/Users/konstantin/Documents/UnitCoin/build/build.h: FORCE
	cd /Users/konstantin/Documents/UnitCoin; /bin/sh share/genbuild.sh /Users/konstantin/Documents/UnitCoin/build/build.h
