...
uint256 hashGenesisBlock("0xdba06080b3797848d1a4517df7328d40483eeb50182b68293560174e796dab20");
...
const string strMessageMagic = "UnitCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // UnitCoin: 1 days
static const int64 nTargetSpacing = 120; // UnitCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal utcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UnitCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc9553685e8158927019714dfb45cdc42ff90412c2b1336c8d6ad28d57337d2e7");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0x72e0c2fdbb8fa2a6e646cdb9f14faffc59258fc984be7b5d4e929fae925a8fca"));
